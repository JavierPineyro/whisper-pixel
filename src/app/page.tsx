...
export default function HomePage() {
  return (
    <main className="bg-background text-foreground flex h-full items-center justify-evenly gap-6 px-4 py-8">
      <section className="flex-1 px-4 py-0">
        <Card className="bg-card/50 border-purple-800/20 pb-0 h-full min-h-96">
      ...
      <section className="flex-col items-center justify-center gap-4 p-4 md:flex-1 lg:flex">
        <h1 className="text-lg text-center text-pretty md:text-4xl">
