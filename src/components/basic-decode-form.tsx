        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-center w-full">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-34 border-2 border-dashed rounded-lg cursor-pointer bg-background/50 hover:bg-background/80 border-border"
            >
